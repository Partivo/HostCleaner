...
namespace ResetHosts
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
			...
			{
				MessageBox.Show("Something went wrong.", "Partivo - Host Cleaner");
			}
		}
        ...
        private void button2_Click(object sender, EventArgs e)
        {
			try
			{
				...
				MessageBox.Show("Process completed.", "Partivo - Host Cleaner");
			}
			catch (Exception ex)
			{
				MessageBox.Show("Something went wrong.", "Partiv - Host Cleaner");
			}
		}
